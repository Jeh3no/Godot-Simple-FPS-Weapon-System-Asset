### Important precision about the asset licence, please read it if you want/plan to make a commercial game with this asset !!
...
The "polygonal-modern-weapons-collection-1-asset-package" asset is licenced under GPL 3.0 and CC-BY-SA 3.0 licences, which mean that i have to licence this asset under the same licences.

If you want to get rid of theses licences once you have the asset (and so be able to make a commercial game/project with this asset) you'll need to geet rid of all the content coming from the "polygonal-modern-weapons-collection-1-asset-package" asset.
